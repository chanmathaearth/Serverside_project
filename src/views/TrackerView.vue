...
<template>
    <div id="app">
        ...
        <div class="flex mt-[8%] justify-center items-center">
            <div v-if="user">
            <h1 class="text-center font-extralight text-2xl">Welcome, <span class="text-2xl font-extralight">{{ user.first_name.toUpperCase() }}!</span></h1>
            </div>
            ...
            <button @click="logout" class="flex justify-center items-center text-center hover:text-red-500 ml-3 focus:outline-none">
                <h1 class="underline text-center font-extralight text-xs ">LOGOUT</h1>
            </button>
        </div>
