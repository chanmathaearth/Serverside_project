...
<template>
    <div id="app">
        ...
        <section class="text-center p-8 mt-16">
            ...
            <p class="mt-2 text-xl font-extralight">Manage your products and inventory below.</p>
        </section>

        <div class="flex mt-1  justify-center">
            <button @click="openModal" class="flex mt-2 font-extralight bg-red-600 text-white p-2 rounded-2xl focus:outline-none transition-all duration-300 hover:scale-110 " type="button">
                ...
                <div class="relative p-4 max-h-full w-[40%]">
                    <div class="relative bg-white rounded-lg shadow">
                        <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t">
                            <h3 class="text-lg font-extralight">ADD PRODUCT</h3>
                        ...
                        <form @submit="addProduct" id="addProductForm" class="p-6">
                            ...
                            <div class="mb-4">
                                ...
                                <button type="button" @click="addSizeField" class="bg-red-500 font-extralight text-white p-2 rounded-xl text-sm mt-2">ADD SIZE</button>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <button type="button" @click="addImageField" class="bg-red-500 font-extralight text-white p-2 rounded-xl text-sm mt-2">ADD IMAGE</button>
                            </div>

                            <div class="mt-6">
                                <button type="submit" class="bg-red-500 font-extralight text-white px-4 py-2 rounded-full mt-2 w-full focus:outline-none">ADD PRODUCT</button>
                            </div>
                        </form>
                    </div>
                </div>
        ...
        <div class="flex justify-center">
            <button @click="openModal2" class="flex mt-6 font-extralight bg-red-600 text-white p-2 rounded-2xl focus:outline-none transition-all duration-300 hover:scale-110 " type="button">
            ...
            <div v-if="showModal2" class="fixed inset-0 bg-black bg-opacity-60 flex justify-center z-30 overflow-y-auto">
                <div class="relative p-4 max-h-full w-[40%]">
                    <div class="relative bg-white rounded-lg shadow">
                        <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t">
                            <h3 class="text-lg font-extralight">ADD PROMOTION CODE</h3>
                        ...
                        <form @submit="addPromotion" id="addProductForm" class="p-6">
                            ...
                            <!-- Name -->
                            <div class="mb-4">
                                <label class="block font-extralight">CODE</label>
                                <input type="text" name="code" class="w-full p-2 border rounded-lg" required>
                            </div>
                            <!-- Discount -->
                            <div class="mb-4">
                                <label   label class="block font-extralight">DISCOUNT PERCENTAGE</label>
                            ...
                            <div class="mt-6">
                                <button type="submit" class="bg-red-500 font-extralight text-white px-4 py-2 rounded-full mt-2 w-full focus:outline-none">ADD</button>
                            </div>
                        </form>
                    </div>
                </div>
